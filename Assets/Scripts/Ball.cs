...
public class Ball : MonoBehaviour
{
    ...
    private void Bounce()
    {
        rb.velocity = paddle.GetBounceDirection(transform.position) * speed * Mathf.Lerp(1, 3, GameController.Instance.CurrentLevel/18f);
    }
    ...
    {
        rb.velocity = direction * speed * Mathf.Lerp(1, 3, GameController.Instance.CurrentLevel / 18f);
    }
